        ...
        <div className="w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx-auto">
          ...
          <div>
            ...
            <p className="mt-[1rem] text-white text-opacity-70 text-[18px]">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eius, consectetur officia pariatur ab cum reiciendis alias aliquid ex, fuga assumenda, magnam dolorem dicta omnis vitae!
            </p>
